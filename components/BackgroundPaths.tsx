      ...
      >
        ...
        <defs>
          <linearGradient id="sharedGradient" x1="0%" x2="100%" y1="0%" y2="0%">
            <stop offset="0%" stopColor="rgba(156, 78, 10, 0.5)" />
            <stop offset="50%" stopColor="rgba(245, 166, 35, 0.6)" />
            <stop offset="100%" stopColor="rgba(250, 213, 125, 0.45)" />
          </linearGradient>
        </defs>
...
export default memo(function BackgroundPaths({
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#f2ede4] dark:bg-neutral-950">
